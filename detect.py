...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='test_images/1.mkv', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--input-url', type=str, required=True, help='Input webpage url')
